...
const leedsSchema = [
  {
    ...
    description: "Expert digital marketing agency serving Leeds businesses with SEO, web development, Google Ads, and Meta Ads services.",
...
export default function LeedsPage() {
  return (
    <div className="min-h-screen bg-background">
      <SchemaMarkup schema={leedsSchema} />
