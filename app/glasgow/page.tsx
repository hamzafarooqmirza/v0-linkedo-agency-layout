...
export const metadata = {
  title: "Digital Marketing Agency in Glasgow | Linkedo",
  description:
    "Linkedo delivers expert SEO, web development, and paid advertising for Glasgow businesses. Connect with more customers and grow your brand across Scotland with Linkedo.",
